...
import {IWormholeClientOptions, IWormholeMetadata, IWormholeRequest} from "./types";
...
export default class WormholeClient extends EventEmitter {
    ...
    private getRemoteProxy() {
        ...
        function call(request: IWormholeRequest, metadata: IWormholeMetadata) {
    ...
    private createRequest(path: string, request: IWormholeRequest, metadata: IWormholeMetadata) {
